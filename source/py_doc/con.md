...
### **ConfigParser：配置文件操作**
**作用**：用来操作配置文件
比如有如下配置文件glusterrest.ini, 和Python源码放在同一目录下。
```shell
...
#### **update_wrapper**
功能： 用被包装函数的module, name，doc和dict属性更新包装函数的相应部分，并返回包装函数。
以下是update_wraps函数的实现代码：
```python
